...
&nbsp;&nbsp;&nbsp;&nbsp; After I used K-mean model predict the customer clusters , I have to **add column predicted cluster (or label) for each customer into the last column of table.** (for finding feature imoportance in next step)<br>
